...
const ConceptualPreservation = () => <GlobalLayout>
  ...
  <p>
    ...
    on and now we have two different groups with two different conceptions of
    the same term. These competing conceptions wreak havoc on our codebase.
  </p>
  <p>
    We must work hard to preserve the concepts that matter. We must get them
  ...
  <p>
    ...
    self-documenting code, code that by its very nature ought to make our
    ...
    other format. Neither of these initiatives is enough to secure our
  ...
  <p>
    ...
    necessarily allows our concepts to be open to drift over time, this can be
    very good.
  </p>
  <p>
    ...
    that let's take a different tack. Preserving a concept isn't merely to
  ...
  <p>
    ...
    member who constantly makes the mistake of putting the wrong code in the
  ...
  <p>
    To be clear, writing clean code and good documentation are good practices
    ...
    times it becomes about style over substance. Pair programming is a great way
    to detect conceptual drift, it allows you to go beyond the code artifact
    and actually investigate people's statements of their beliefs.
  </p>
  <p>
    ...
    themselves. To be in possession of a concept is not merely to be able to
  ...
  <p>
    ...
    that despite a person's ability to articulate the infrastructure they do
    not have that deeper knowledge of how to make it reality. But it may also
    be that the architect has not done their job of convincing others.
  </p>
  <Heading size="2" text="Persuade or Don't" />
  <p>
    Preserving our concepts requires persuasion. Merely building a big
  ...
  <p>
    ...
    a good solution to ensure quality? Is the blessed infrastructure team that
    imposes concepts a good idea? Perhaps not.
  </p>
</GlobalLayout>;


export default ConceptualPreservation;
