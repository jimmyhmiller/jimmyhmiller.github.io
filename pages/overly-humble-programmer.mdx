import { Heading, GlobalLayout, Title } from "../utils";
import Head from 'next/head';

<Head>
    <meta
       name="og:description"
       content="Perhaps the bros in Silicon Valley could use some humility, but for the rest of us, we are already quite a bit too humble."
     />
</Head>
...
export default function OverlyHumbleProgrammer({ children }) {
