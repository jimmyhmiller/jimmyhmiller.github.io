import { Heading, GlobalLayout, Title, Term, Image, BlockQuote, Note } from "../utils";
...
<Note>If you enjoyed this, you can hear more on the [interview I did on the Changelog Podcast](https://changelog.com/podcast/609). I talk more about the crazy code here and about the time the Secret Service busted in my door for "Hacking".</Note>


export default function BeautifulMess({ children }) {
