...
> 
> \- [Sean Goedecke: Seeing like a Software Company](https://www.seangoedecke.com/seeing-like-a-software-company/)
...
> Value capture occurs when an agent's values are rich and subtle; they enter a social
> environment that presents simplified — typically quantified — versions of those values; and those simplified articulations come to dominate their practical reasoning. 
>
> \- [Value Capture by C. Thi Nguyen](https://philpapers.org/archive/NGUVCH.pdf)
...
<strong>Edit:</strong>
<br />
Eli Mellen wrote a fantastic response to my post called [The Seed Beneath the Snow](https://eli.li/the-seed-beneath-the-snow). It looks at broad implications perhaps implicit in the argument I'm making here. It has given me a ton to think about. If this resonated with you, I highly recommend it next.
</SubtleBox>

export function SubtleBox({ children }) {
...
export default function LegibilityPage({ children }) {
