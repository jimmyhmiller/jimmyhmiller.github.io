...
<Head>
    <title>Is the Brain a Computer?</title>
    <meta
        name="og:description"
        content="Is there a problem with thinking about the brain as a computer? Yes."
        />
</Head>

<Heading text={<>Is the Brain a Computer? (<Link href="/pdfs/brain-computer.pdf">pdf</Link>)</>} />
...
export default function BrainComputer({ children }) {
