import { Heading, GlobalLayout, Title, Term, Image, Attribution } from "../utils.js";
...
> That will never change. Not here. 
>
> <Attribution>Every senior dev I talked to</Attribution>
...
export default function Stuck({ children }) {
