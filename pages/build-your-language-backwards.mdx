...
<Head>
    <meta
       name="og:description"
       content="If you've every been stuck building a programming language, I figured out a trick. Build it backwards."
     />
</Head>
...
export default function BuildYourLanguageBackwards({ children }) {
