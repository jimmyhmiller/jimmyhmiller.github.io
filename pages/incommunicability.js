...
const Incommunicability = () => <GlobalLayout>
  ...
  <BlockQuote>
    <p>
      One way of stating the main point I want to make is that programming in
      this sense primarily must be the programmers’ building up knowledge of a
      certain kind, knowledge taken to be basically the programmers’ immediate
      possession, any documentation being an auxiliary, secondary product.
    </p>
  </BlockQuote>
  <p>
  ...
  <BlockQuote>
    <p>
      My experiences agree well with Peter Naur's hypothesis that programming
      is "theory building," and they strongly support his conclusion that
      programmers should be accorded high professional status. But I do not
      share Naur's unproved assertion that "reestablishing the theory of a
      program merely from the documentation is strictly impossible." On the
      contrary, I believe that improved methods of documentation are able to
      communicate everything necessary for the maintenance and modification of
      programs.
    </p>
  </BlockQuote>
  <p>
    The goal of this essay is to defend Naur's view that theory is
    incommunicable. Naur himself does provide such a defense, but his defense
    took for granted philosophical background knowledge not shared by his
    readers. Not only this, but Naur's defense is indirect. Here we will make
    explicit what was implicit in Naur, namely his reliance on Gilbert Ryle's
    notion of theory building and division of knowledge into two distinct
    kinds. Having explicated the background Naur assumed, we will examine more
    closely his claims.
  </p>
  <Heading size="3" text="Ryle's Theory Building" />
  <p>
  ...
  <BlockQuote>
    <p>
      ...
      any more than to have a pen is to be writing with it. To have a pen is
      to be in a position to write with it, if occasion arises to do so; and
      to have a theory or plan is to be prepared either to tell it or to apply
      it, if occasion arises to do so. The work of building a theory or plan
      is the work of getting oneself so prepared.
    </p>
  </BlockQuote>
  <p>
  ...
  <BlockQuote>
    <p>
      Having a theory or plan is not merely being able to tell what one’s
      theory or plan is. Being able to tell a theory is, in fact, being able
      to make just one, namely the didactic exploitation of it. Mastery of
      Euclid’s theorems is not merely ability to cite them; it is also ability
      to solve riders to them, meet objections to them and find out the
  ...
  <Heading size="4" text="Knowing How and Knowing That" />
  <p>
    ...
    "knowing how" doesn't require prior instances of "knowing that". This
    second claim we will not explore further, but in order to understand
    Ryle's notion of theory, we must explore more Ryle's separation of these
    two forms of knowing.
  </p>
  <p>
    The stereotypical example used in philosophy when discussing this topic is
  ...
  <p>
    There are some who suggest "knowing how" is just a species of "knowing
    that". In the case of our juggler, the suggestion might be that there are
    certain propositions that the juggler knows such as "If I am juggling N
    objects, I need to throw them up X feet at Y angle." In fact, if "knowing
    how" is reducible to "knowing that", our juggler knows all sorts of
    propositions of this type. But, as Ryle argues, one could know all
    possible propositions about juggling and still themselves not be a skilled
    juggler. Juggling requires practice, it requires "muscle memory", it
    requires us to build up knowledge of how, not just propositions about the
    activity of juggling.
  </p>
  <BlockQuote>
    <p>
      ...
      its turn, to prepare him for a variety of tasks, only some of which will
      be further teachings.
    </p>
  </BlockQuote>
  <p>
    Here we can see Ryle's insistence that theories require a sort of "knowing
    ...
    that for which it must be employed.
  </p>
  <BlockQuote>
    <p>
      Sherlock Holmes’ theories were primarily intended to be applied in the
      apprehension and conviction of criminals, the thwarting of planned
      crimes and the exculpation of innocent suspects….His theories were
      applied, if further deductions were actually made from them, and if
      criminals were arrested and suspects released in accordance with them.
    </p>
  </BlockQuote>
  <Heading size="3" text="Programming as &quot;Knowing how&quot;" />
  <p>
    With this philosophical background laid out, it becomes much easier to see
    what Naur might mean by statements like:
  </p>
  <BlockQuote>
    <p>
      A main claim of the Theory Building View of programming is that an
  ...
  <p>
    ...
    documentation can capture fully the theory of any program. If having a
  ...
  <p>
    ...
    lived) only in our heads. Try as we might, we cannot communicate this
    theory in its full.
  </p>
  <p>
...
export default Incommunicability;